...
function decipher(message) {
    ...
    words.forEach(word =>
        wordsCount.set(word, wordsCount.get(word) ? wordsCount.get(word) + 1 : 1 )
    )

    console.log(stringifyMap(wordsCount))
}

decipher(CHALLENGE_INPUT)